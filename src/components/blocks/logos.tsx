...
export const Logos = () => {
  const topRowCompanies = [
    {
      name: "Mercury",
      logo: withBasePath("/logos/mercury.svg"),
      width: 143,
      height: 26,
    ...
    {
      name: "Watershed",
      logo: withBasePath("/logos/watershed.svg"),
      width: 154,
      height: 31,
    ...
    {
      name: "Retool",
      logo: withBasePath("/logos/retool.svg"),
      width: 113,
      height: 22,
    ...
    {
      name: "Descript",
      logo: withBasePath("/logos/descript.svg"),
      width: 112,
      height: 27,
  ...
  const bottomRowCompanies = [
    {
      name: "Perplexity",
      logo: withBasePath("/logos/perplexity.svg"),
      width: 141,
      height: 32,
    ...
    {
      name: "Monzo",
      logo: withBasePath("/logos/monzo.svg"),
      width: 104,
      height: 18,
    ...
    {
      name: "Ramp",
      logo: withBasePath("/logos/ramp.svg"),
      width: 105,
      height: 28,
      href: "https://ramp.com",
    },
    {
      name: "Raycast",
      logo: withBasePath("/logos/raycast.svg"),
      width: 128,
      height: 33,
    ...
    {
      name: "Arc",
      logo: withBasePath("/logos/arc.svg"),
      width: 90,
      height: 28,
      href: "https://arc.com",
    },
